...
scp -o "ProxyCommand ${PROXY_CMD}" -o 'UserKnownHostsFile=/dev/null' -o 'StrictHostKeyChecking=no' -o 'ServerAliveInterval=60' -i ${RSA_KEY_FILE} -P ${REMOTE_ACCESS_PORT} ${SOURCE} ${USERNAME}@127.0.0.1:${TARGET}
